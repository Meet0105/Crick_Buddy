          ...
          <tbody className="bg-gray-800/50 divide-y divide-gray-700/30">
            {bowlingStats.map((stat, index) => (
              ...
              >
                ...
                <td className="px-3 sm:px-4 md:px-6 py-2.5 sm:py-3 md:py-4 whitespace-nowrap text-xs sm:text-sm md:text-base font-medium text-red-400">
                  {stat.wickets || '0'}
                </td>
                <td className="px-3 sm:px-4 md:px-6 py-2.5 sm:py-3 md:py-4 whitespace-nowrap text-xs sm:text-sm md:text-base text-gray-300">
                  {stat.average ? stat.average.toFixed(2) : '0.00'}
                </td>
                <td className="px-3 sm:px-4 md:px-6 py-2.5 sm:py-3 md:py-4 whitespace-nowrap text-xs sm:text-sm md:text-base font-medium text-cyan-400">
                  {stat.economy ? stat.economy.toFixed(2) : '0.00'}
                </td>
