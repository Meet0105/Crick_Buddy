...
const TeamsDropdown = () => {
  return (
    <div className="bg-slate-800 text-gray-100 rounded-xl shadow-2xl w-64 py-2">
      ...
      <div className="py-1">
        <Link href="/teams" className="block px-4 py-3 text-sm text-gray-100 hover:bg-slate-700 transition-colors flex items-center rounded-md">
          <svg className="w-5 h-5 text-blue-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          International Teams
        </Link>
        <Link href="/teams/domestic" className="block px-4 py-3 text-sm text-gray-100 hover:bg-slate-700 transition-colors flex items-center rounded-md">
