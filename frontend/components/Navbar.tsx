...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-slate-900 via-slate-950 to-black text-gray-100 shadow-xl sticky top-0 z-50 w-full overflow-visible">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <div className="relative" ref={liveScoresDropdownRef}>
              ...
              {isDropdownOpen['live-scores'] && (
                <div className="absolute right-0 mt-2 w-56 bg-slate-800 border border-slate-700 rounded-xl shadow-2xl py-2 z-[100]">
            ...
            <div className="relative" ref={seriesDropdownRef}>
              ...
              {isDropdownOpen['series'] && (
                <div className="absolute right-0 mt-2 w-48 bg-slate-800 border border-slate-700 rounded-xl shadow-2xl py-2 z-[100]">
