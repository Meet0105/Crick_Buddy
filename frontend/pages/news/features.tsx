    ...
    <div className="bg-gray-900 min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-4 py-6">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-green-400 mb-6">Features</h1>
        ...
        {news && news.length > 0 ? (
          ...
          <div className="bg-gray-800 text-gray-400 p-8 rounded-lg text-center">
            ...
            <h3 className="text-xl font-bold text-gray-100 mb-2">No Features Available</h3>
            <p className="mb-4">Feature articles are currently being synced. Please check back later!</p>
