...
exports.getPhotoGallery = exports.getPhotoById = void 0;
...
const getPhotoById = async (req, res) => {
    ...
    try {
        ...
        let photoFromDB = await Photo_1.default.findOne({ photoId: id });
        ...
        const photo = new Photo_1.default(photoData);
        await photo.save();
        res.json(photo);
    }
    catch (error) {
        console.error('getPhotoById error:', ((_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message || error);
...
const getPhotoGallery = async (req, res) => {
    ...
    try {
        ...
        console.error('getPhotoGallery error:', ((_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message || error);
        // Handle rate limiting
        if (((_b = error === null || error === void 0 ? void 0 : error.response) === null || _b === void 0 ? void 0 : _b.status) === 429) {
            return res.status(429).json({
                message: 'API rate limit exceeded. Please try again later.',
