...
const searchPlayers = async (req, res) => {
    ...
    try {
        ...
        console.error('searchPlayers error:', ((_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message || error);
        ...
        res.status(500).json({ message: 'Failed to search players', error: ((_c = error === null || error === void 0 ? void 0 : error.response) === null || _c === void 0 ? void 0 : _c.data) || error.message });
    }
};
