...
const mapStatusToEnum = (status) => {
    if (!status)
        return 'COMPLETED'; // For recent helpers, default to COMPLETED if no status
...
function extractMatchInfo(matchInfo, matchScore, originalMatch) {
    ...
    return {
        ...originalMatch,
        matchId: ((_e = matchInfo.matchId) === null || _e === void 0 ? void 0 : _e.toString()) || originalMatch.matchId,
        format,
        title,
        ...
        result: {
            resultText,
            winnerTeam,
            winType: matchInfo.winType || ((_f = matchInfo.margin) === null || _f === void 0 ? void 0 : _f.type) || '',
            winMargin: matchInfo.winMargin || ((_g = matchInfo.margin) === null || _g === void 0 ? void 0 : _g.value) || 0
        },
        tossResults,
